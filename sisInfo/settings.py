"""
Django settings for sisInfo project.
...
SECRET_KEY = 'django-insecure-_4kde)fw#m&@ptnzcax*+sqp(=-n_1j**au@orq-___5!mh7lv'
...
WSGI_APPLICATION = 'sisInfo.wsgi.application'
